...
function searchOnPage(searchTerm) {
    ...
    if (searchTerm === '') {
        ...
        $("#no-results-message").hide(); // Hide the no results message
    } else {
    ...
    if (!hasResults && searchTerm !== '') {
        $("#no-results-message").text("No results found for '" + searchTerm + "'."); // Display the no results message
        $("#no-results-message").show(); // Show the no results message
    } else {
        $("#no-results-message").hide(); // Hide the no results message
    }
}
